let data = {
    componentType: 'avue-card',
    option: {
        props: {
            img: 'img', title: 'title', info: 'text'
        }
    }, data: [{
        title: 'Alipay',
        text: '333212121212333在中台产品的研发过程中，会出现不同的设计规范和实现方式，但其中往往存在很多类似的页面和组件，这些类似的,在中台产品的研发过程中，会出现不同的设计规范和实现方式，但其中往往存在很多类似的页面和组件，这些类似的',
